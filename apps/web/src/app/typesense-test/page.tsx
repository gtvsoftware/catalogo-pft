...
export default function TypesenseTestPage() {
  ...
  return (
    <div style={{ padding: 20, fontFamily: 'Inter, Arial, sans-serif' }}>
      ...
      {error && (
        <div style={{ color: 'crimson', marginBottom: 12 }}>Erro: {error}</div>
      )}
      ...
      <div style={{ marginTop: 20, fontSize: 13, color: '#666' }}>
        Dica: este componente é um "client component" e mantém foco do input
        enquanto você digita. Se a tela estiver sendo remontada, verifique se
        você não está atualizando parâmetros de rota ou re-renderizando o layout
        do servidor.
      </div>
    </div>
  )
